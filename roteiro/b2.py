# -*- coding: utf-8 -*-
# Bloco 2 · Luiany Gonçalves Carvalho · slides 22 a 40 · K-Means
FALAS = {

22: """Obrigada, Henrique. Meu nome é Luiany Carvalho e eu vou conduzir o Bloco 2, que é onde a
...
23: """Pra escolher centróides eu preciso de um critério que diga que uma escolha é melhor que a
...
24: """Antes do algoritmo, vamos calcular esse J na mão, porque quando a gente calcula uma vez fica
...
25: """O algoritmo de Lloyd resolve o impasse com um truque simples: como é difícil otimizar as
...
26: """Eu disse que o centro ótimo é a média; vamos provar isso. Fixando as atribuições, o custo do
...
27: """Essa mesma prova, agora em desenho e em uma dimensão só. O eixo horizontal é onde eu coloco
...
28: """Agora vamos separar bem os dois meios-passos, porque é aqui que muita gente se confunde. Vou
...
29: """Aqui a mesma coisa numa escala maior: duzentos e setenta pontos, três grupos, com o
...
30: """Até agora eu venho dizendo "escolho K" como se fosse trivial, e não é. Tem uma armadilha
...
31: """Vale abrir a silhueta, porque a fórmula é intuitiva. Para um ponto i, o a de i é a distância
...
32: """Agora dá pra brincar com o K ao vivo. Vou arrastar de um até oito. Com K igual a um, o J é
...
33: """Duas coisas estragam o K-Means silenciosamente, sem dar erro, entregando um resultado bonito
...
34: """Deixa eu detalhar essa semeadura. O primeiro centro é sorteado uniformemente. Depois, pra
...
35: """Aqui está essa roleta funcionando. Cada ponto do gráfico virou uma fatia da barra de
...
36: """O segundo modo silencioso de errar é a escala, e esse é mais traiçoeiro porque não depende
...
37: """Esse é o K-Means inteiro escrito do zero, e cabe em vinte e cinco linhas de NumPy. Destaco a
...
38: """Uma aplicação que fecha bem o bloco: quantização de cores. Numa imagem, cada pixel é um
...
39: """E agora a parte mais importante do meu bloco: onde esse algoritmo quebra. O K-Means tem uma
...
40: """Fechando o Bloco 2. O que fica é: o Lloyd minimiza a inércia por descida alternada, com
