# -*- coding: utf-8 -*-
# Bloco 1 · Henrique Matheus Mendonça de Miranda · slides 01 e 08 a 21 · Fundamentos e variáveis latentes
FALAS = {
...
8: """Vamos começar pela diferença que define tudo. No aprendizado supervisionado, o conjunto de
...
11: """Pra isso não ficar abstrato, quatro casos concretos. Em visão computacional, o observado é
...
12: """Este slide formaliza a estrutura com um modelo gráfico: é o mesmo desenho do slide dez,
...
13: """Agora um detalhe de notação que parece burocrático e não é. A latente é categórica: ela diz
...
14: """Esse laboratório é só pra fixar a mecânica do slide anterior, porque na primeira vez que a
...
16: """Aqui a mesma ideia como árvore genealógica, pra registrar que isso não para nos três casos
...
17: """E chegamos ao conceito central do meu bloco: a responsabilidade. A pergunta é: dado que eu
