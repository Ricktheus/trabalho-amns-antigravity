# -*- coding: utf-8 -*-
# Bloco 3 · Antonio Carlos de Barcelos Fernandes · slides 35 a 52 · Misturas de Bernoulli e EM
FALAS = {

35: """Obrigado, Luiany. Eu sou o Antonio Fernandes e no Bloco 3 a gente ataca a dívida que ela
...
36: """A saída é trocar distância por probabilidade. Se cada dimensão é um bit, a distribuição
...
37: """Vale insistir nessa mudança. No K-Means o mu era um ponto geométrico, um lugar no espaço;
...
38: """Pra deixar palpável, aqui dá pra desenhar. Eu clico nos quadradinhos e monto um dígito na
...
39: """Agora a dificuldade técnica do bloco. O modelo completo é uma mistura: somo, sobre os K
...
40: """Esse laboratório existe só pra fixar essa pedra no caminho. À esquerda eu tenho ln de a mais
...
41: """A ideia do EM é resolver um ovo e galinha. Se eu soubesse de qual grupo veio cada amostra,
...
42: """Na mistura de Bernoulli, os dois passos ficam em fórmula fechada. No passo E eu calculo a
...
43: """Vamos rodar com seis amostras na unha. Aqui estão os seis vetores binários e dois
...
44: """E por que ele sobe sempre? Essa é a prova de convergência. Para qualquer distribuição q
...
45: """Aqui está o argumento em desenho. A curva de cima é o log da verossimilhança, que eu não sei
...
46: """Agora em escala: trezentas e sessenta imagens sintéticas de oito por oito, com ruído de bit
...
47: """Duas coisas quebram o EM na prática, e as duas são numéricas. A primeira: se um bit nunca
...
48: """A primeira cura. Em vez de estimar mu pela razão pura das contagens, eu somo
...
49: """A segunda cura é o log-sum-exp, um truque que vale pra vida inteira. O problema: eu preciso
...
50: """Aqui dá pra ver os dois lados na mesma tela. À esquerda, o cálculo ingênuo em float64:
...
51: """E aqui está tudo junto em código. Reparem que o logsumexp está implementado com o truque do
...
52: """Fechando o Bloco 3. O que fica é: no hipercubo binário a distribuição nativa é a Bernoulli
