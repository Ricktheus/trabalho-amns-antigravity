# -*- coding: utf-8 -*-
# Bloco 4 · Bianca Fernandes Visco · slides 53 a 67 · GMM, demonstração e comparação
FALAS = {

53: """Obrigada, Antonio. Eu sou a Bianca Visco e vou fechar a apresentação com o modelo mais geral
...
54: """Vamos abrir a gaussiana multivariada em duas partes. A primeira é o termo de normalização,
...
55: """Vale destrinchar a matriz dois por dois, que é como a gente entende e depois generaliza. Na
...
56: """Aqui dá pra sentir com a mão. Tenho três controles: as duas variâncias e a correlação.
...
57: """Agora, por que a Mahalanobis é a métrica certa. Imaginem uma nuvem alongada na diagonal e
...
58: """E aqui está o argumento na tela, com uma nuvem inclinada e dois pontos de teste. Olhem os
...
59: """O EM para GMM é o mesmo esqueleto do Bloco 3, com uma equação a mais. O passo E é idêntico:
...
60: """Rodando ao vivo. No começo as elipses estão todas parecidas, mais ou menos circulares,
...
61: """Mas essa flexibilidade toda tem um preço, e é uma patologia séria. Se um componente colapsar
...
62: """O scikit-learn deixa escolher quanta liberdade geométrica dar, em quatro opções. Spherical:
...
63: """Aqui dá pra varrer sozinho: eu escolho o tipo de covariância e o K, e a curva de BIC se
...
64: """Agora a demonstração que amarra tudo: mesmo conjunto, três faixas alongadas e inclinadas,
...
65: """E tem um bônus que só o GMM entrega, por ser generativo: detecção de anomalia. Como eu tenho
...
66: """Esse quadro resume os três métodos lado a lado. Domínio: K-Means e GMM em espaço contínuo,
...
67: """Pra fechar, três mensagens. Primeira: é tudo um arcabouço só — a variável latente discreta
